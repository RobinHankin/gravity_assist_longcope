`longcope` <- function(n=1000){
    ...
    levels_ap <- unique(sort(c(1 + (1:10)/100,1+(1:10)/10,3:10,30)))  # aphelion
    ...
    ## plot commands start
    plot(0:1,xlim=c(0,sqrt(2)),ylim=c(0,sqrt(2)),type = "n",xlab=expression(v[phi]),ylab=expression(v[r]),axes=FALSE,main="Longcope velocity-space map of Keplerian orbits",asp=1)
